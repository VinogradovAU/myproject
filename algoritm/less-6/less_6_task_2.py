...
# вариант № 2 (использование очереди)
def size_obj():
    summ_size = 0
    for k in globals():
...
# Переменная/объект xx занимает 312
# Переменная/объект k занимает 26
# Переменная/объект summ_size = 688 занимает 14
# Переменная/объект k = k занимает 26
# **************************************************
# Локальные и глобальные переменные заняли: 728 байт
#
