class Settings {
    ...
    init(params) {
        let levelcalc = [15, 20, 25]; //процентов бомб на пполе в зависимости от уровня сложности
        ...
        this.countWin = this.newParams.boardSize * this.newParams.boardSize - this.bombs; // число клеток на поле, которые надо открыть до победы

        console.log("bombs: " + this.bombs, "levelGame: " + this.newParams.levelGame, "win_count:" + this.countWin);
